...
# TODO: Replace placeholder URLs after creating the first GitHub Release.
_MODELS: list[dict[str, str | int]] = [
    {
        "name": "classifier_efficientnetb0_v1.keras",
        "url": "https://github.com/<owner>/RIAWELC/releases/download/v1.0.0/classifier_efficientnetb0_v1.keras",
        "size": 46_470_910,
    },
    {
        "name": "segmentation_unet_v2.keras",
        "url": "https://github.com/<owner>/RIAWELC/releases/download/v1.0.0/segmentation_unet_v2.keras",
        "size": 102_831_694,
    },
]
